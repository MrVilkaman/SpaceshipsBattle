...
public  class WaveContainer {
    ...
    public static final int LEVEL_30 = LEVEL_29+1;
    public static final int LEVEL_31 = LEVEL_30+1;
    public static final int LEVEL_32 = LEVEL_31+1;
    public static final int LEVEL_33 = LEVEL_32+1;
    public static final int LEVEL_34 = LEVEL_33+1;
    public static final int LEVEL_35 = LEVEL_34+1;
    public static final int LEVEL_36 = LEVEL_35+1;
    public static final int LEVEL_37 = LEVEL_36+1;
    public static final int LEVEL_38 = LEVEL_37+1;
    public static final int LEVEL_39 = LEVEL_38+1;
    public static final int LEVEL_40 = LEVEL_39+1;

    public static final int LEVEL_MIN = LEVEL_1;
    public static final int LEVEL_MAX = LEVEL_40;
    ...
    private static IWaveController get(int id,IAddedEnemy iAddedEnemy) {
        ...
        switch (id){
            case LEVEL_TEST:
                ...
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2,10, -0.2f);
            ...
            case LEVEL_14:
                    ...
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_1, 1, 0.01f, new Point(Constants.CAMERA_WIDTH+10,-100), 145);
                    unitWave.waitLastKilled();
                    ...
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_1, 1, 0.01f, new Point(-100, Constants.CAMERA_HEIGHT+10), 325);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_1, 1, 3f, new Point(Constants.CAMERA_WIDTH_HALF -50,Constants.CAMERA_HEIGHT +10), 270);
                    ...
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_1, 1, 0.01f, new Point(Constants.CAMERA_WIDTH_HALF,-50), 90);
           ...
           case LEVEL_18:
            ...
            case LEVEL_20:
                ...
                unitWave.addDelay(1f);
                for (int i = 0;i<6;i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 1, 0.1f,new Point(400+130*i ,-100), 90);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 1, 0.1f, new Point(400 + 130 * i,
                ...
                for (int i = 0;i<6;i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_2, 1, 0.1f,new Point(400+130*i ,-100), 90);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_2, 1, 0.1f,new Point(400+130*i ,Constants.CAMERA_HEIGHT + 100), 270);
                }
                break;
            case LEVEL_21:

                for (int i = 0;i<6;i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 10+i/2, 1f - i*0.1f);
                    if (i%2  == 1){
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_SHIELD_L_1, 1+i, 0.4f);
                    }else{
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_SHIELD_L_1, 1+i, 0.5f);
                    }
                }
                break;
            case LEVEL_22:

                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 5, 0.6f);
                for (int i = 0;i<3;i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_1, 20, 0.1f);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_SHIELD_L_1, 2, 0.5f);
                }
                ...
                break;
            case LEVEL_23:
                int dh = Constants.CAMERA_HEIGHT_HALF/4;
                for (int j = 0; j<2;j++) {

                    if (j==0){
                        for (int i = 0; i<3;i++) {
                            unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_L_1, 1, 0.3f + j*1.5f, new Point(-100,100 + dh*i), 0);
                        }
                        unitWave.waitLastKilled();
                    } else {
                        for (int i = 0; i<3;i++) {
                            unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_SHIELD_L_1, 1, 0.3f + j*1.5f, new Point(-100,100 + dh*i), 0);
                        }
                    }

                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_SHIELD_L_1, 1, 0.01f, new Point(-100, Constants.CAMERA_HEIGHT+10), 325);
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_SHIELD_L_1, 1, 1.2f, new Point(-100,-100), 35);

                    for (int i = 0; i<3; i++) {
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 1, 0.01f, new Point(-100,Constants.CAMERA_HEIGHT_HALF-200), 0);
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 1, 0.4f, new Point(-100,Constants.CAMERA_HEIGHT_HALF+200), 0);
                    }

                    for (int i = 0; i<3;i++) {
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 1, 0.01f, new Point(-100, Constants.CAMERA_HEIGHT+10), 325);
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 1, 1.2f, new Point(-100,-100), 35);
                    }
            ...
            case LEVEL_26:
                ...
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 10, -0.1f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_1, 20, 0.3f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_SHIELD_L_1, 2, 0.3f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_1, 20, 0.3f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 5, 0.5f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_1, 20, 0.3f);

                break;
            case LEVEL_27:
                for (int i = 0; i<10; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_2, 1, 0.2f, new Point(Constants.CAMERA_WIDTH-100*i,Constants.CAMERA_HEIGHT), 220);
                }
                unitWave.addDelay(1f);
                for (int i = 9;  0<=i; i--) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_2, 1, 0.2f, new Point(Constants.CAMERA_WIDTH-100*i,Constants.CAMERA_HEIGHT), 220);
                ...
                unitWave.waitLastKilled();
                for (int i = 0; i<10; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_3, 1, 0.2f, new Point(Constants.CAMERA_WIDTH-100*i,Constants.CAMERA_HEIGHT), 220);
                }
                unitWave.addDelay(1f);
                for (int i = 9;  0<=i; i--) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_3, 1, 0.2f, new Point(Constants.CAMERA_WIDTH-100*i,Constants.CAMERA_HEIGHT), 220);
                ...
                for (int i = 0; i<8; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 1, 0.1f, new Point(Constants.CAMERA_WIDTH,Constants.CAMERA_HEIGHT-100*i), 180);
                }
                unitWave.addDelay(1f);
                for (int i = 7;  0<=i; i--) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 1, 0.2f, new Point(Constants.CAMERA_WIDTH,Constants.CAMERA_HEIGHT-100*i), 180);
                }

                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_1, 10, 0.2f);
                break;
            case LEVEL_28:
                unitWave.startFog();
                unitWave.addDelay(2f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 5, - 0.2f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 15, 0.8f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_L_1, 8, 1.2f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 15, 0.8f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_1, 5, 1.5f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_L_1, 8, 1.2f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 10, 0.9f);
                break;
            case LEVEL_29:
                unitWave.startFog();
                unitWave.addDelay(2f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_3, 3, 0.4f);
                for (int i = 0; i<4; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_2, 2, 0.4f, new Point(1100 -100*i,-110), 150);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_2, 2, 0.4f, new Point(1100 -100*i, Constants.CAMERA_HEIGHT+10), 210);
                }
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_3, 3, 1.2f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_2, 5, 1.4f);
            ...
            case LEVEL_31:
                ...
                unitWave.addDelay(2f);
                for (int i = 0;i<5;i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_1, 2, 0.2f);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 1, 0.2f);
                }
                for (int i = 0;i<5;i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 2, 0.2f);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 1, 0.2f);
                }
                for (int i = 0;i<5;i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 1, 0.4f);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 1, 0.2f);
                }
                for (int i = 0;i<5;i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_SHIELD_L_1, 2, 0.4f);
                ...
                for (int i = 0;i<5;i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_1, 2, 0.8f);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 1, 0.2f);
                }
            ...
            case LEVEL_32:
                ...
                break;
            case LEVEL_33:
                dh = Constants.CAMERA_HEIGHT_HALF/4;
                for (int i = 0;i<3;i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_2, 1, 0.01f, new Point(-100, Constants.CAMERA_HEIGHT+10), 325);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_2, 1, 0.01f, new Point(-100,-100), 35);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_SHIELD_L_1, 3, 0.01f);
                    unitWave.waitLastKilled();
                }
                for (int i = 0;i<3;i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_2, 1, 0.01f, new Point(Constants.CAMERA_WIDTH, Constants.CAMERA_HEIGHT+10), 205);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_2, 1, 0.01f, new Point(Constants.CAMERA_WIDTH,-100), 155);
                    for (int j = 0; j<3;j++) {
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_SHIELD_L_1, 1, 0.01f, new Point(-100,100 + dh*j), 0);
                    }
                    unitWave.waitLastKilled();
                }

                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 1, 0.01f, new Point(-100, Constants.CAMERA_HEIGHT+10), 325);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 1, 0.01f, new Point(-100,-100), 35);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 3, 0.01f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 1, 0.01f, new Point(Constants.CAMERA_WIDTH, Constants.CAMERA_HEIGHT+10), 205);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 1, 0.01f, new Point(Constants.CAMERA_WIDTH,-100), 155);
                for (int j = 0; j<3;j++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 1, 0.01f, new Point(-100,100 + dh*j), 0);
                }

                break;
            case LEVEL_34:
                for (int i = 1; i < 11; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_1,i*2,0.2f);
                    unitWave.addDelay(1f);
                }
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_2, 1, 0.01f);
                unitWave.addDelay(1f);
                for (int i = 1; i < 11; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_1,i*3,0.2f);
                    unitWave.addDelay(1f);
                }
            ...
            case LEVEL_35:
                ...
                for (int i = 1; i <= n; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_1,1,0.01f,new Point(Constants.CAMERA_WIDTH+10,dh*i));
                }
                unitWave.waitLastKilled();
                for (int i = 1; i <= n; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_2,1,0.01f,new Point(Constants.CAMERA_WIDTH+10,dh*i));
                }
                unitWave.waitLastKilled();
                for (int i = 1; i <= n; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_3,1,0.01f,new Point(Constants.CAMERA_WIDTH+10,dh*i));
                }
                unitWave.waitLastKilled();
                for (int i = 1; i <= n; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_1,1,0.01f,new Point(Constants.CAMERA_WIDTH+10,dh*i));
                }
                unitWave.waitLastKilled();
                for (int i = 1; i <= n; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_L_1,1,0.01f,new Point(Constants.CAMERA_WIDTH+10,dh*i));
                }
                unitWave.waitLastKilled();
                for (int j = 0;j<3;j++) {
                    for (int i = 1; i <= n; i++) {
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1,1,0.01f,new Point(Constants.CAMERA_WIDTH+10,dh*i));
                    }
                }
                unitWave.waitLastKilled();
                for (int i = 1; i <= n; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_2,1,0.01f,new Point(Constants.CAMERA_WIDTH+10,dh*i));
                }
                unitWave.waitLastKilled();
                for (int i = 1; i <= n; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_1,1,0.01f,new Point(Constants.CAMERA_WIDTH+10,dh*i));
                }
                unitWave.waitLastKilled();
                for (int i = 1; i <= n; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2,1,0.01f,new Point(Constants.CAMERA_WIDTH+10,dh*i));
                }
                unitWave.waitLastKilled();
                for (int i = 1; i <= n; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2,1,0.01f,new Point(Constants.CAMERA_WIDTH+10,dh*i));
            ...
            case LEVEL_36:
                ...
                int nn = 8;
                dh = Constants.CAMERA_HEIGHT/(n+2);
                int dw = Constants.CAMERA_WIDTH / (nn + 2);

                for (int j =0;j < 2;j++) {
                    for (int i = 1; i <= n; i++) {
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_3,1,0.2f,new Point(Constants.CAMERA_WIDTH+10,dh*i));
                    }

                    for (int i = nn-1; 0 <= i; i--) {
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_3,1,0.2f,new Point(dw*i,Constants.CAMERA_HEIGHT+10),270);
                    }

                    for (int i = nn-1; 0 < i; i--){
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_3,1,0.2f,new Point(-100,dh*i),0);
                    }

                    for (int i = 1; i <= n; i++) {
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_L_3,1,0.2f,new Point(dw*i,-100),90);
                    }

                    for (int i = 1; i <= n; i++) {
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_SHIELD_L_1,1,0.2f,new Point(Constants.CAMERA_WIDTH+10,dh*i));
                    }

                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_2,2,0.2f);
                }

                break;
            case LEVEL_37:
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_1, 3, 0.1f);
                unitWave.startFog();
                unitWave.addDelay(2f);
                for (int i = 0; i<2; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 1, 0.1f, new Point(700,-100), 150);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 1, 0.1f, new Point(800,-100), 150);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_SHIELD_L_1, 1, 0.1f, new Point(900,-100), 150);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 1, 0.1f, new Point(1000,-100), 150);
                    unitWave.addDelay(2f);
                }
                unitWave.waitLastKilled();
                for (int i = 0; i<2; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 1, 0.1f, new Point(700,Constants.CAMERA_HEIGHT + 100), 210);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 1, 0.1f, new Point(800,Constants.CAMERA_HEIGHT + 100), 210);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_SHIELD_L_1, 1, 0.1f, new Point(900,Constants.CAMERA_HEIGHT + 100), 210);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 1, 0.1f, new Point(1000,Constants.CAMERA_HEIGHT + 100), 210);
                    unitWave.addDelay(2f);
                }
                unitWave.waitLastKilled();
                for (int i = 0; i<2; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 1, 0.1f);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 1, 0.1f);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_SHIELD_L_1, 1, 0.1f);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 1, 0.1f);
                    unitWave.addDelay(2f);
                }
                unitWave.waitLastKilled();
                ...
                for (int i=0;i<3;i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_L_1, 3, 0.1f);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 1, 0.01f,new Point(-50,Constants.CAMERA_HEIGHT + 50),181);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 1, 0.01f,new Point(Constants.CAMERA_WIDTH + 50,Constants.CAMERA_HEIGHT + 50),270);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 1, 0.01f,new Point(Constants.CAMERA_WIDTH + 50,-50),0);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 1, 0.01f,new Point(50,-50),90);
                    unitWave.waitLastKilled();
                    if (i == 1){
                        unitWave.stopFog();
                    }
                ...
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_SHIELD_L_1, 1, 0.1f);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_SHIELD_L_1, 1, 0.1f, new Point(900,Constants.CAMERA_HEIGHT + 100), 210);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 1, 0.1f, new Point(1000,-100), 150);
                unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_2, 1, 0.1f);
            ...
            case LEVEL_39:
                ...
                for (int j = 0;j<5;j++) {
                    for (int i = 1; i <= n; i++) {
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1,1,0.2f,new Point(Constants.CAMERA_WIDTH+10,dh*i),0);
                    }
                    for (int i = 1; i <= n; i++) {
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1,1,0.2f,new Point(-100,dh*i),0);
                    }
                    for (int i = 1; i <= n; i++) {
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3,1,0.01f,new Point(Constants.CAMERA_WIDTH+10,dh*i));
                    }
                }
                ...
                for (int j = 0;j<5;j++) {
                    ...
                    for (int i = 1; i <= n; i+=2) {
                        unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_L_1,1,0.01f,new Point(-100,dh*i),0);
                    }
                }
                break;
            case LEVEL_40:
                unitWave.startFog();
                for (int i = 0; i < 5; i++) {
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_SHIELD_L_1, 1+i/2, 0.5f);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_SINGLE_GUN_SHIELD_L_3, 10+i, 0.3f);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_METEOR_L_1, 2+i, 0.5f);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_MINIGUN_SHIELD_L_1, 1+i/2, 0.5f);
                    unitWave.addEnemy(BaseUnit.TYPE_ENEMY_ROCKET_SHIELD_L_2, 1, 1.5f);
